...
class VenueCode(db.Model, SerializerMixin):
    ...
    venue_code_template_id = db.Column(
        db.Integer, db.ForeignKey("venue_code_template.id"), nullable=True
    )
    # code
...
class Visit(db.Model, SerializerMixin):
    ...
    # venue code
    venue_code_id = db.Column(
        db.String(64), db.ForeignKey("venue_code.id"), nullable=True
    )
